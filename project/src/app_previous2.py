...
COUNTRY_COLOURS = {
    ...
    "Germany": "#e15759",
    "Mexico": "#76b7b2",
    "United States of America": "#59a14f",
}
...
st.plotly_chart(style_chart(time_chart), use_container_width=True)
...
segment_margin = segment_performance.copy()
...
right_col.plotly_chart(style_chart(discount_chart), use_container_width=True)
...
discount_band_chart = px.bar(
    discount_band_summary.sort_values("Profit Margin", ascending=False),
    x="Discount Band",
    y="Profit Margin",
