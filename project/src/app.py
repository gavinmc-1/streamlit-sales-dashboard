...
st.write(
    "Analysing sales, profit, product performance, customer segments, "
    "countries, and discounting patterns."
)
...
time_chart = style_chart(time_chart)
...
product_margin_chart = style_chart(product_margin_chart)
...
segment_chart = style_chart(segment_chart)
...
country_chart = style_chart(country_chart)
...
discount_chart = style_chart(discount_chart)
...
discount_band_chart = style_chart(discount_band_chart)
